...
# Get the User INPUT for number of Break
#ask_user_input1()
...
if testresult == "Passed":
    print("\n====tud_cm Test Result====")
    testResultMessage = "Test PASSED! It took ", end_time - start_time, " seconds... for {} instances".format(inst_terminate_num)
    print("\n"+str(testResultMessage))

    notificationMessage="TUD_CM test PASSED of OMER ISMAIL\n "+str(testResultMessage)

elif testresult == "Failed":
    print("\n====tud_cm Test Result====")
    testResultMessage = "Test FAILED! It took ", end_time - start_time, " seconds... for {} instances".format(inst_terminate_num)
    print("\n" + str(testResultMessage))

    notificationMessage = "TUD_CM test FAILED of OMER ISMAIL\n " + str(testResultMessage)
else:
...
# print("\n====tud_cm Test Result====")
# print("\n 2 instances stopped, 2 instances reinstated in ", end_time - start_time," seconds...test pass!")
...
def ActivateLambdaNotifcation(notificationMessage):
    ...
    response = lambdaClient.invoke(
        FunctionName='arn:aws:lambda:eu-west-1:809334161727:function:notify_me_chaos_monkey',
        InvocationType='RequestResponse',
        LogType='Tail',
        Payload=json.dumps(payload),
    )
    print("Sending notification to lambda to send Email and Text SMS with update...")


ActivateLambdaNotifcation(notificationMessage)
